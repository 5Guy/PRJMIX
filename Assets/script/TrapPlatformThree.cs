...
/// <summary>
/// 투명 위치 오브젝트 3개를 기준으로 Thermal 함정 3개를 설치하는 버전입니다.
/// 큐브는 바꾸지 않고, Inspector에 연결한 Trap Point 위치들에 함정만 생성합니다.
/// </summary>
[ExecuteAlways]
public class TrapPlatformThree : MonoBehaviour
{
    [Header("생성 설정")]
    ...
    [Tooltip("세 번째 함정이 설치될 투명 위치 오브젝트입니다.")]
    [SerializeField] private Transform trapPointC;
    ...
    /// <summary>
    /// Inspector에 연결한 투명 위치 오브젝트들에 Thermal 함정 3개를 생성합니다.
    /// </summary>
    [ContextMenu("Build Thermal Traps")]
    public void Build()
    {
        TrapPlatformBuilder.BuildTraps(this, trapParent, thermalTrapPrefab, new[] { trapPointA, trapPointB, trapPointC });
    }
